...
public class DefaultMovieService implements MovieService {
    ...
    @Override
    public Page<IdentifiableMovieDTO> getPaginatedMovies(Pageable pageable) {
        return new PageImpl<>(movieRepository.findAll(pageable).stream().map(MovieDTOMapper::toMovieDTO).collect(Collectors.toList()));
    }
